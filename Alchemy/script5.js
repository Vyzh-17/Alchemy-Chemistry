...
const reactions = [
  { question: "Br₂ + H₂ → ?", choices: ["HBr", "KBr", "RbBr", "NaBr"], correctAnswer: "HBr" },
  { question: "Kr + Cl₂ → ?", choices: ["KrCl₂", "RbCl", "SrCl₂", "ZrCl₄"], correctAnswer: "KrCl₂" },
  { question: "Mo + O₂ → ?", choices: ["MoO₂", "NbO₂", "ZrO₂", "SrO"], correctAnswer: "MoO₂" }
];
